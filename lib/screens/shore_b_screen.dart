...
class ShoreBScreen extends StatefulWidget {
  const ShoreBScreen({Key? key}) : super(key: key);

  @override
  State<ShoreBScreen> createState() => _ShoreBScreenState();
}

class _ShoreBScreenState extends State<ShoreBScreen> {
