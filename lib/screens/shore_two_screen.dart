...
class ShoreTwoScreen extends StatefulWidget {
  const ShoreTwoScreen({Key? key}) : super(key: key);

  @override
  State<ShoreTwoScreen> createState() => _ShoreTwoScreenState();
}

class _ShoreTwoScreenState extends State<ShoreTwoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Shore power 2'),),
        body:  Container(
