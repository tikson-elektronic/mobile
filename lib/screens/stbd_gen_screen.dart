...
class StbdGenScreen extends StatefulWidget {
  const StbdGenScreen({Key? key}) : super(key: key);

  @override
  State<StbdGenScreen> createState() => _StbdGenScreenState();
}

class _StbdGenScreenState extends State<StbdGenScreen> {
